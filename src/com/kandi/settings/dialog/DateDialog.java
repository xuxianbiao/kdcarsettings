...
import com.kandi.settings.model.SetDate_WheelMain;
import com.kandi.settings.widgets.SetDate_JudgeDate;
import com.kandi.settings.widgets.SetDate_ScreenInfo;
import com.kandi.settings.widgets.SetDate_SystemDateTime;
...
public class DateDialog extends Dialog{
	...
	private void initView(){
		...
		toptitle.setText(context.getResources().getString(R.string.set_data));
		...
		if("".equals(dataformat) || dataformat == null){
			Settings.System.putString(getContext().getContentResolver(), Settings.System.DATE_FORMAT,context.getString(R.string.yyyymmdd));
		}
