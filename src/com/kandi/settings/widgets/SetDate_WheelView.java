 ...
 */
public class SetDate_WheelView extends View {
	/** Scrolling duration */
	...
	// Wheel Values
	private SetDate_WheelAdapter adapter = null;
	...
	// Listeners
	private List<SetDate_OnWheelChangedListener> changingListeners = new LinkedList<SetDate_OnWheelChangedListener>();
	private List<SetDate_OnWheelScrollListener> scrollingListeners = new LinkedList<SetDate_OnWheelScrollListener>();

	/**
	 * Constructor
	 */
	public SetDate_WheelView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * Constructor
	 */
	public SetDate_WheelView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initData(context);
	}
	 ...
	 * Constructor
	 */
	public SetDate_WheelView(Context context) {
		super(context);
		initData(context);
	}
	 ...
	 * @return the adapter
	 */
	public SetDate_WheelAdapter getAdapter() {
		return adapter;
	}
	 ...
	 */
	public void setAdapter(SetDate_WheelAdapter adapter) {
	 ...
	 *            the listener
	 */
	public void addChangingListener(SetDate_OnWheelChangedListener listener) {
	 ...
	 *            the listener
	 */
	public void removeChangingListener(SetDate_OnWheelChangedListener listener) {
	...
	protected void notifyChangingListeners(int oldValue, int newValue) {
		for (SetDate_OnWheelChangedListener listener : changingListeners) {
	 ...
	 *            the listener
	 */
	public void addScrollingListener(SetDate_OnWheelScrollListener listener) {
	 ...
	 *            the listener
	 */
	public void removeScrollingListener(SetDate_OnWheelScrollListener listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (SetDate_OnWheelScrollListener listener : scrollingListeners) {
	...
	private int getMaxTextLength() {
		SetDate_WheelAdapter adapter = getAdapter();
		if (adapter == null) {
			return 0;
		}
